...
//        intent.setData(Uri.fromParts("package", context.getPackageName(), null));
    ...
    private static Intent huawei (Context context) {
        ...
        intent.setComponent(new ComponentName("com.huawei.systemmanager", "com.huawei.systemmanager.addviewmonitor" +
                ".AddViewMonitorActivity"));
        if (hasIntent(context, intent)) return intent;
        intent.setComponent(new ComponentName("com.huawei.systemmanager", "com.huawei.notificationmanager.ui" +
